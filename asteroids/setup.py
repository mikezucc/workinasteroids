...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Asteroids1_0.py"
 
        #Name of program
        self.project_name = "Asteroids"
        ...
        #Auhor of program
        self.author_name = "Jun wei Zhu"
        self.author_email = "junweizhu1@msn.com"
        self.copyright = "Copyright (c) 2012 Jun wei Zhu."
 
        #Description
        self.project_description = "A simple Asteroids game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['FreeMono.ttf','img']
